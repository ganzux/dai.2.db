...
<?
		...
		if (isset ($_GET['Submit']))
			...
			{	
				...
				$query = "CREATE TABLE $dbname.$dbpref$hp (id INT AUTO_INCREMENT PRIMARY KEY,id_sala INT,id_pelicula INT,hora_inicio VARCHAR(6),fecha date)";
				$result = mysql_query($query);
				...
				$query = "CREATE TABLE $dbname.$dbpref$reservas_temporal (id INT AUTO_INCREMENT PRIMARY KEY,id_proyeccion int,CONSTRAINT FOREIGN KEY(id_proyeccion) REFERENCES proyecciones(id))";
				$result = mysql_query($query);
				...
				$query = "CREATE TABLE $dbname.$dbpref$butacas_temporal (id INT AUTO_INCREMENT PRIMARY KEY,id_reserva int,butaca int,CONSTRAINT FOREIGN KEY(id_reserva) REFERENCES reservas_temporal(id))";
				$result = mysql_query($query);
