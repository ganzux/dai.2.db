--    @'C:\Documents and Settings\AlVaRiTo\Escritorio\foro miércoles_casa\foro_script.sql'
SET DEFINE OFF
SET LINESIZE 6000
...
SELECT foro_usuarios.id, vista_usuarios_mensajes.num_mensajes, foro_usuarios.email, foro_usuarios.nombre, foro_usuarios.nick
