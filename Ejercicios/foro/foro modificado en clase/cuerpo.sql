...
<CENTER><div class="copyright">Powered by PL/SQL © 2007 iTo Group</div></CENTER></BODY></HTML>');
...
HTP.P('<div align="center"><img src="../alumnos/Alvaro/jpg/webito.gif" width="150" height="75"></div>
  
  <table width="75%"  border="0" align="center" cellspacing="5">
  <tr>
    <td>');
    IF nomb IS NOT NULL THEN
      HTP.P('<A HREF="foro.salir" class="mainmenu"><img src="../alumnos/Alvaro/jpg/desc.gif" border=0> Desconectarse ['||nomb||']</A></div>');
    ELSE
      HTP.P('<A HREF="foro.login" class="mainmenu"><img src="../alumnos/Alvaro/jpg/registrese.gif" border=0> Inicio de Sesión</A></div>');
    END IF;
    ...
    <td><div align="center" class="mainmenu"><A><img src="../alumnos/Alvaro/jpg/faq.gif" border=0>Futuro</A></div></td>
    <td><div align="center" class="mainmenu"><A><img src="../alumnos/Alvaro/jpg/buscar.gif" border=0>Futuro</A></div></td>
    <td><div align="center" class="mainmenu"><A><img src="../alumnos/Alvaro/jpg/lista.gif" border=0>Futuro</A></div></td></td>
  </tr>
...
BEGIN
  ...
  IF id_tema_pasada IS NOT NULL THEN
    ...
    HTP.P('<p><H2><center>Tema: " '||tem||' "</center></H2></p><table width="90%"  border="0" cellspacing="5" align="center">
    <tr>
...
BEGIN
	...
	IF nombre IS NOT NULL THEN
		HTP.P('<center><form name="formulario" method="GET" action="foro.crear_nuevo_tema">
...
nombre := busca_usuario;
	...
	HTP.P('<center><H2>Perfil de '||nombre||'</h2></center>
  Falta poner un formulario para editar los datos del usuario
  ');
  pie;
    ...
    cabecera('Error , Logueate');
		HTP.P('<center><h3>Error, no está logueado en el sistema</h3></center>');
  	pie;  
	END IF;
